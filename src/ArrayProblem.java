...
public class ArrayProblem {
	...
	/**
	 * Problem_1_1 Получаем массив int, выдаем массив без повторений в том же порядке.
	 *
	...
	/**
	 * Problem_1_2 Получаем массив int, выдаем массив без повторений в том же порядке.
	 *
	 * @param integers из передаваемого массива, убираються повторении
	 * @return возвращается массив без повторений
	 */
	...
	/**
	 * Problem_2_1 Получаем массив, если сумма четная то выводим "even" или наоборот "odd"
	 *
	...
	/**
	 * Problem_2_2 Получаем массив, если сумма четная то выводим "even" или наоборот "odd"
	 *
	 * @param array подсчитывается сумма из данного массива
	 * @return выводиться "even" если четное или "odd" если не четное
	 */
	...
	/**
	 * Problem_3_1 Получает массив символов, возвращает наименьшее занчение или индекс наименьшее значение
	 *
